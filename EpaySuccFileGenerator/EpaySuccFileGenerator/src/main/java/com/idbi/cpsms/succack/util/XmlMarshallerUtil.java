package com.idbi.cpsms.succack.util;
...
/**
 * Small utility to marshal JAXB objects to XML files.
 * Central place if you want to tune encoding, formatting, etc.
 */
public final class XmlMarshallerUtil {
    ...
    public static <T> void marshalToFile(T jaxbObject, Class<T> jaxbClass, File file) throws Exception {
        ...
        // If CPSMS strictly needs UTF-8 declaration, this is the default; you can set explicitly:
