...
public class CreditInfo {
	...
	public CreditInfo(Long id, String batchNumber, String paymentProd, String bankCode, String cpsmsCreditTran,
			String creditIfsc, String creditAccountNumber, String creditBankIin, String creditUid,
			String creditAccountName, BigDecimal creditAmount, String creditStatus, String pmtMtd, Timestamp tranDateFt,
			String tranIdFt, String initiatingUtr, String debitTranId) {
		this.id = id;
	...
	public String toString() {
		return "CreditInfo{" + "id=" + id + ", batchNumber='" + batchNumber + '\'' + ", paymentProd='" + paymentProd
				+ '\'' + ", bankCode='" + bankCode + '\'' + ", cpsmsCreditTran='" + cpsmsCreditTran + '\'' + '}';
	}
}
