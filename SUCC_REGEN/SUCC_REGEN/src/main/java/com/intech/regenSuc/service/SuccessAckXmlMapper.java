...
import com.intech.regenSuc.bean.SuccessPayments.BatchDetails;
import com.intech.regenSuc.bean.SuccessPayments.BatchDetails.SuccessPayment;
...
public class SuccessAckXmlMapper {
	...
	public SuccessAckXmlMapper(@Qualifier("SuccRegenProps") Properties successAckProperties) {
